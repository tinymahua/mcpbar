...
Welcome to `mcpbar` contributor's guide.
...
If you experience bugs or general issues with `mcpbar`, please have a look
...
You can help improve `mcpbar` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mcpbar` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mcpbar`'s files. While this mechanism can
...
```
conda create -n mcpbar python=3 six virtualenv pytest pytest-cov
conda activate mcpbar
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mcpbar.git
   cd mcpbar
   ```
...
5. Install [pre-commit]:
   ...
   `mcpbar` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mcpbar
[issue tracker]: https://github.com/<USERNAME>/mcpbar/issues
